    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-menu">
            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                ...
                <a class="btn btn-secondary" href="./"><i class="icon-graph"></i> &nbsp;{{ __('words.posts') }}</a>
                <a class="btn btn-secondary" href="#"><i class="icon-settings"></i> &nbsp;{{ __('words.add post') }}</a>
            </div>
        </li>
    </ol>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <select name="category_id" id="" class="form-control">
                                    @foreach ($categories as $category)
                                            <option value="{{ $category->id }}">{{ $category->translate(app()->getLocale())->title }}</option>
                                    @endforeach
                                </select>
